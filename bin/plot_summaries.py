...
def plot_summaries(tsv_file, output_pdf):
    ...
    df_plot = df.melt(id_vars="Homoeologue", value_vars=["Unmodified_Reads", "Modified_Reads"], 
    ...
    ax1.set_title("Absolute Read Counts per Homoeologue")
    ...
    ax2.set_title("Editing Efficiency per Homoeologue")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--input", required=True, help="Input TSV file from parse_edits.py")
